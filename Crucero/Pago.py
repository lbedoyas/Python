...
def Pagar():
	...
	#Decision de pago
	print("****************************")
	print("Por favor, Elija la opcion de tipo de pago a realizar")
	print("Si es de contado escriba la letra C")
	print("Si es de financiado escriba la letra F")
	print("****************************")
	vcliente = 0
	tipoPago = input("Por favor, Elija la opcion de tipo de pago a realizar......  ")
	...
	conexion = sqlite3.connect("crucero.sqlite")
	...
	argumentos = (mes, valorMes, tipoPago, vcliente)
 
	#consulta SQL con argumentos ?, ?

	sql = """INSERT INTO Pago VALUES (null, ?, ?, ?, ?)"""
